...
CHECKLIST_PATH = Path("knowledge/pca_checklist.yml")
...
def semantic_validate_pca(doc_text: str, client) -> Tuple[float, List[Dict]]:
    ...
    system_msg = (
        "Você é um auditor especializado em planejamento anual de contratações (PCA) segundo a Lei 14.133/2021. "
        "Avalie se o DOCUMENTO atende semanticamente ao CHECKLIST. "
        "Considere sinônimos, redações equivalentes e conteúdo implícito."
        "Responda exclusivamente em JSON no formato:\n"
        "{ \"itens\": [ {\"id\":..., \"presente\":true/false, \"adequacao_nota\":0-100, \"justificativa\":\"...\", \"faltantes\":[]} ] }"
    )
