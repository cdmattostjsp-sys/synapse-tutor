# knowledge/validators/contrato_semantic_validator.py
# Validador semântico para CONTRATO: usa LLM para avaliar presença e adequação de cada item do checklist.
...
# Caminho para checklist de CONTRATO
CHECKLIST_PATH = Path("knowledge/contrato_checklist.yml")
...
def semantic_validate_contrato(doc_text: str, client) -> Tuple[float, List[Dict]]:
    """
    ...
    system_msg = (
        "Você é um auditor técnico-jurídico especializado em contratos administrativos e na Lei 14.133/2021. "
        "Avalie se o DOCUMENTO atende, de forma SEMÂNTICA, cada item do CHECKLIST de CONTRATOS. "
