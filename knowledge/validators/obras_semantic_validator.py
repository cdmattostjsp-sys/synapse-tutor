# knowledge/validators/obras_semantic_validator.py
# Validador semântico para OBRAS: usa LLM para avaliar "presença" e "adequação" de cada item do checklist.
...
# Caminho para checklist de OBRAS
...
def semantic_validate_obras(doc_text: str, client) -> Tuple[float, List[Dict]]:
    """
    ...
    system_msg = (
        "Você é um auditor técnico-jurídico especializado em obras públicas, "
        "na Lei 14.133/2021 e nas normas do TCU/TCE. "
